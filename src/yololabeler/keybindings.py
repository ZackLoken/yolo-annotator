...
KEY_BINDINGS = (
    ...
    _b("prev_item", ("<Up>",), "Up", "Previous queue item", "queue"),
...
MOUSE_HELP = (
    ...
    ("Left-click drag", "Draw a box (on empty space)", "box"),
    ("Click inside a box", "Select it; does not start a new box", "box"),
    ("Drag a corner", "Resize; the opposite corner stays fixed (selected box)", "box"),
    ("Drag the body", "Move the whole box (selected box)", "box"),
    ("Right-click", "Delete box", "box"),
